<template>
    <li class="relative" ref="dropdownRef">
        ...
        >
            ...
            <span
                v-if="countNotificationsCount > 0"
                        ...
                        <div class="flex flex-col flex-grow">
                            <p class="flex flex-wrap gap-1 text-sm">
                                ...
                                <span class="font-normal">
                                    {{ notification.application_status }} your
                                </span>
...
const loadNotifications = async () => {
    ...
    const { data, error } = await fetchFreelancerNotifications();
...
const countNotificationsCount = computed(
    () =>
