<template>
    ...
    >
        ...
        >
            ...
            <!-- Details Grid -->
            <section
                class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-800 text-sm"
            >
                <!-- Budget -->
                ...
                <div class="flex items-center gap-3">
                    <i
                        class="fa-2x far fa-calendar-alt text-green-500 mt-1"
                    ></i>
                    <div class="flex flex-col gap-0">
                ...
                <div class="flex items-center gap-3">
                    <i
                        class="fa-2x far fa-calendar-check text-red-500 mt-1"
                    ></i>
                    <div class="flex flex-col gap-0">
            ...
            >
                <button
                    ...
                    class="flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-[#FD0585] hover:from-pink-600 hover:to-[#dc4e98] cursor-pointer py-2.5 px-6 text-white text-sm sm:text-base font-semibold shadow-md hover:shadow-lg transition-all duration-300 ease-in-out transform hover:scale-105"
                >
