<template>
  <div class="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
    ...
    <!-- Loading -->
    <div v-if="isLoading" class="flex items-center gap-2 text-gray-500 text-lg">
    ...
    <div
      v-if="fetchError"
      class="bg-red-100 text-red-700 p-4 rounded-lg mb-4 border border-red-200"
    >
      {{ fetchError }}
    </div>
    ...
    >
      ...
      >
        <!-- Icon -->
        <div
          class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-100 text-blue-600 text-lg flex-shrink-0"
        >
    ...
    <div
      ...
      class="flex flex-col items-center mt-10 text-gray-500"
    >
...
function viewNotification(id,application_id) {
    ...
    Inertia.get(route('project.show', { id: id, application_id: application_id }), {}, {
        onError: (errors) => {
