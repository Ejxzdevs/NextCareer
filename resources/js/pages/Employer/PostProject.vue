<template>
    <MainLayout>
        <!-- Page Container with vertical scroll -->
                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        >
                            <!-- Dropdown -->
                            <div
                                class="absolute top-4 right-4 dropdown-wrapper"
                            >
                                <button
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            class="fas fa-edit text-blue-500"
                                        ></i>
                                        Edit
                                    </a>
                                    <a
                            ...
                            <!-- Title -->
                            <h2
                                class="text-lg font-bold text-blue-800 mb-3 line-clamp-1"
                            >
                                {{ project.title }}
                            </h2>
                    ...
                    >
                        <i
                            class="fas fa-box-open text-6xl mb-4 text-gray-300"
                        ></i>
                        <p class="text-xl font-semibold mb-2">
                            No projects posted yet!
                        </p>
                        <p class="text-gray-600">
                            It looks like you haven't listed any projects. Start
                            by clicking the
        ...
        >
            ...
            >
                ...
                <h3
                    class="text-2xl text-center font-bold text-gray-600 mb-6 title"
                >
...
const filteredProjects = computed(() => {
    return projects.filter((project) => {
        const matchTitle = project.title
            .toLowerCase()
            .includes(searchProjectTitle.value.toLowerCase());
        const matchStatus =
            selectProjectStatus.value === "" ||
            project.project_status === selectProjectStatus.value;
        const matchCategory =
            selectProjectCategory.value === "" ||
            project.category === selectProjectCategory.value;
